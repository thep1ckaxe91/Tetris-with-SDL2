...
namespace sdlgame {
    ...
    const Uint32 K_=SDL_SCANCODE_LCTRL;
    const Uint32 K_=SDL_SCANCODE_TAB;
    const Uint32 K_=SDL_SCANCODE_CAPSLOCK;
    const Uint32 K_=SDL_SCANCODE_ESCAPE;
    const Uint32 K_=SDL_SCANCODE_RALT;
    const Uint32 K_=SDL_SCANCODE_RCTRL;
    const Uint32 K_=SDL_SCANCODE_UP;
    const Uint32 K_=SDL_SCANCODE_DOWN;
    const Uint32 K_=SDL_SCANCODE_LEFT;
    const Uint32 K_=SDL_SCANCODE_RIGHT;
    const Uint32 K_=SDL_SCANCODE_LSHIFT;
    const Uint32 K_=SDL_SCANCODE_RSHIFT;

    const Uint32 K_=SDL_SCANCODE_KP_0;
    const Uint32 K_=SDL_SCANCODE_KP_1;
    const Uint32 K_=SDL_SCANCODE_KP_2;
    const Uint32 K_=SDL_SCANCODE_KP_3;
    const Uint32 K_=SDL_SCANCODE_KP_4;
    const Uint32 K_=SDL_SCANCODE_KP_5;
    const Uint32 K_=SDL_SCANCODE_KP_6;
    const Uint32 K_=SDL_SCANCODE_KP_7;
    const Uint32 K_=SDL_SCANCODE_KP_8;
    const Uint32 K_=SDL_SCANCODE_KP_9;

    const Uint32 K_=
    const Uint32 K_=SDL_SCANCODE_KP_ENTER;
    const Uint32 K_=SDL_SCANCODE_KP_AMPERSAND;
    const Uint32 K_=SDL_SCANCODE_KP_AT;
    const Uint32 K_=SDL_SCANCODE_KP_BACKSPACE;
    const Uint32 K_=SDL_SCANCODE_KP_COLON;
    const Uint32 K_=SDL_SCANCODE_KP_COMMA;
    const Uint32 K_=SDL_SCANCODE_KP_DECIMAL;
    const Uint32 K_=SDL_SCANCODE_KP_DIVIDE;

    const Uint32 K_=SDL_SCANCODE_LEFTBRACKET;
    const Uint32 K_=SDL_SCANCODE_RIGHTBRACKET;
    const Uint32 K_=SDL_SCANCODE_MINUS;
    const Uint32 K_=SDL_SCANCODE_EQUALS;
    const Uint32 K_=SDL_SCANCODE_PAGEDOWN;
    const Uint32 K_=SDL_SCANCODE_PAGEUP;
    const Uint32 K_=SDL_SCANCODE_PRINTSCREEN;
    const Uint32 K_=SDL_SCANCODE_RETURN;
    const Uint32 K_=SDL_SCANCODE_BACKSPACE;
    const Uint32 K_=SDL_SCANCODE_BACKSLASH;
